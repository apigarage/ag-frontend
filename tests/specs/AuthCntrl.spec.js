...
describe('Controller: Auth', function() {
  ...
  describe('Sign Up', function () {
    ...
    // password is empty
    describe('If Password Email String is Provided', function(){
    ...
    describe('All Information is provided', function(){
      var $httpBackend ;
      beforeEach(inject(inject(function(_$httpBackend_) {
        // Set up the mock http service responses
        $httpBackend = _$httpBackend_;
        // backend definition common for all tests
        $httpBackend.expectPOST('http://dev.chinman.backend.com/api/users',{name: "test", 
                                  email: "test@test.ca",
                                  password: "test123"})
